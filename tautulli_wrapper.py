...
class Tautulli:
    ...
    async def get_item_user_stats(self, rating_key: str, params: Dict[str, Any] = None) -> Optional[Dict[str, Any]]:
    ...
    async def get_item_watch_time_stats(self, rating_key: str, params: Dict[str, Any] = None) -> Optional[Dict[str, Any]]:
    ...
    async def terminate_session(self, session_key: int = None, session_id: str = None, message: str = None) -> int:
    ...
    async def get_library_media_info(self, section_id=None, rating_key=None, media_info=0, length=50, include_metadata=0) -> Optional[Dict[str, Any]]:
